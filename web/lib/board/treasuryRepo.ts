...
export async function fetchCotoFinances(supabase: SupabaseClient, cotoId: string): Promise<CotoFinanceRow[]> {
...
export async function insertManualExpense(
  ...
  input: { cotoId: string; amount: number; description: string }
